...
export const GlobalHeader = () => {
    ...
    return (
        <header className={cn(
            ...
            "bg-os-primary-bg/80 backdrop-blur-md border-b border-os-primary-border",
            ...
            <div className="flex items-center gap-4">
                <div className="flex items-center gap-2 font-bold text-sm tracking-wide">
                    <div className="w-6 h-6 bg-ph-orange rounded flex items-center justify-center text-white font-mono text-xs">
                        P
                    </div>
            ...
            <button
                ...
                className={cn(
                    ...
                    "bg-os-tertiary-bg/50 border border-os-primary-border hover:bg-os-tertiary-bg",
                    "transition-all duration-200 group cursor-pointer"
                )}
            >
                <Search size={14} className="text-os-primary-muted group-hover:text-ph-orange transition-colors"/>
                <span className="text-xs text-os-primary-muted font-medium hidden sm:inline-block">Search...</span>
                <span
                    className="flex items-center gap-0.5 text-[10px] text-os-primary-muted font-mono bg-os-primary-bg px-1 rounded border border-os-primary-border ml-2">
                   <Command size={10}/> K
                </span>
            </button>
            ...
            <div className="flex items-center gap-3 sm:gap-4">
                ...
                {/* 1. Availability Status (The Money Button) 💰 */}
                <Tooltip content="Open Contact Info" side="bottom">
                    <button
                        onClick={() => window.open('mailto:me@example.com')}
                        className="hidden md:flex items-center gap-2 px-2 py-1 rounded hover:bg-os-primary-accent transition-colors"
                    >
                ...
                <Tooltip content="Check my Code" side="bottom">
                    <button
                        ...
                        className="hidden md:flex items-center justify-center p-1.5 rounded hover:bg-os-primary-accent transition-colors text-os-primary-text/80 hover:text-os-primary-text"
                    >
                        <Github size={18} />
                    </button>
                </Tooltip>

                <div className="h-4 w-[1px] bg-os-primary-border hidden sm:block" />

                {/* 2. Control Center Icons (Wifi, Sound, Battery) */}
                <Tooltip content="Control Center" side="bottom">
                    <div className="flex items-center gap-3 px-2 py-1 rounded hover:bg-os-primary-accent transition-colors cursor-default">
                ...
                <div className="flex flex-col items-end leading-none min-w-[60px]">
                    <span className="text-[13px] font-bold font-mono tracking-wide">{time}</span>
                    <span className="text-[11px] text-os-primary-muted font-medium hidden sm:block">
                        {date}
                    </span>
                </div>
            </div>
